...
//		#4. char --> A008_2
		...
		boolean b1 = false; System.out.println(b1);
	
		b1 = true;          System.out.println(b1);
		
		b1 = false;         System.out.println(b1);
		
		System.out.println("#2. 정수 byte short int long");
		byte by = 1; short sh = -2; int in = 3; long lo = -4L;
